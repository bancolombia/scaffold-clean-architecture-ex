    ...
    %{
      ...
      transformations:
        [
          ...
          {:inject_dependency, ~s|{:telemetry, "~> 1.4"}|},
          {:inject_dependency, ~s|{:opentelemetry_exporter, "~> 1.10"}|},
          {:inject_dependency, ~s|{:opentelemetry_api, "~> 1.5"}|},
          {:inject_dependency, ~s|{:otel_plug, "~> 1.3"}|},
